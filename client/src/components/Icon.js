...
export const Icon = ({ name, size = 24, color = 'currentColor' }) => {
  const iconProps = { width: size, height: size, viewBox: '0 0 24 24', fill: 'none', stroke: color, strokeWidth: 2, strokeLinecap: 'round', strokeLinejoin: 'round' };
  ...
  const icons = {
    ...
    reports: (
      <svg {...iconProps}>
        ...
        <polyline points="22 7 20 11 22 15"></polyline>
        <polyline points="2 7 4 11 2 15"></polyline>
      </svg>
    ),
    logout: (
      <svg {...iconProps}>
    ...
    whatsapp: (
      <svg {...iconProps} fill={color} stroke="none" viewBox="0 0 24 24">
    ...
    stethoscope: (
      <svg {...iconProps}>
        <path d="M4.8 2.3A.3.3 0 0 1 5 2.5V8a5 5 0 0 0 10 0V2.5a.3.3 0 0 1 .5-.2l1.6 1.6a.3.3 0 0 1 .1.2V8a7 7 0 0 1-14 0V4.1a.3.3 0 0 1 .1-.2L4.8 2.3z"></path>
        <path d="M10 15v3a4 4 0 0 0 8 0v-1"></path>
